...
process make_vcfs {
    ...
    input:
    set val(sample), file(sv), file(snv),  file("*closer_sorted_merged.bed"), file("*close_unique_sorted_merged.bed"), file("*unclustered_sorted_merged.bed"), file("*closer.bed"), file("*close.bed"), file("*unclustered.bed") from beds
    file fasta_ref
